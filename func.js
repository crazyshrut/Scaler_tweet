...
like.addEventListener('click', () =>{
    let ticket = document.querySelector('.ticket-footer');
    ticket.querySelector("img").src = "https://d2beiqkhq929f0.cloudfront.net/public_assets/assets/000/064/025/original/state_clicked.png?1706888455";
